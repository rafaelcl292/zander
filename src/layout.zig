...
pub fn write(writer: *std.Io.Writer) !void {
    try writer.writeAll("{\n");
    inline for (.{ z.search_support.Stack, z.position.StateInfo, z.nnue_accumulator.Accumulator, z.nnue_accumulator.Stack, z.nnue_accumulator.CacheEntry, z.nnue_accumulator.Caches, z.position.Position, z.tt.Entry, z.tt.Cluster }, 0..) |T, index| {
